...
class Augmenter(object):
    ...
    **deprecated
    ...
    def __init__(self, seed=None, name=None, **deprecated):
        ...
        valid_deprecated_kwargs = {"random_state", "deterministic"}
        for key in deprecated:
            assert key in valid_deprecated_kwargs, (
        ...
        deterministic = False
        if "deterministic" in deprecated:
            ia.warn_deprecated(
                ...
                stacklevel=4)
            deterministic = deprecated["deterministic"]
        ...
        if "random_state" in deprecated:
            assert seed is None, "Cannot set both `seed` and `random_state`."
            seed = deprecated["random_state"]
...
class Sequential(Augmenter, list):
    ...
    def __init__(self, children=None, random_order=False,
        ...
        Augmenter.__init__(self, seed=seed, name=name, **deprecated)
...
class Identity(Augmenter):
    ...
    def __init__(self, seed=None, name=None, **deprecated):
        super(Identity, self).__init__(seed=seed, name=name, **deprecated)
...
class Noop(Identity):
    ...
    def __init__(self, seed=None, name=None, **deprecated):
        super(Noop, self).__init__(seed=seed, name=name, **deprecated)
...
class Lambda(Augmenter):
    ...
    def __init__(self, func_images=None, func_heatmaps=None,
                 ...
                 seed=None, name=None, **deprecated):
        super(Lambda, self).__init__(seed=seed, name=name, **deprecated)
